                            ...
                            <div class="col-xl-12">
                                ...
                                @if (session()->has('amount_invalid'))
                                    <div class="alert alert-warning alert-dismissible fade show" role="alert">
                                        <strong>Warning!</strong> {{ session('amount_invalid') }}
                                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                    </div>
                                @endif
                            </div>
                            <table wire:ignore.self id="example5" class="table align-middle table-row-bordered table-row-gray-100 gs-0 gy-3">
                                <thead>
